...
with p1:
    st.markdown(f"""
    <div style="background:#1a1a1a; padding:20px; border-radius:16px; border:1px solid {inj_color}; height:320px;">
        <span style="font-size:28px;">⚠️</span>
...
with p2:
    st.markdown(f"""
    <div style="background:#1a1a1a; padding:20px; border-radius:16px; border:1px solid {chr_color}; height:320px;">
        <span style="font-size:28px;">🩺</span>
...
with p3:
    st.markdown(f"""
    <div style="background:#1a1a1a; padding:20px; border-radius:16px; border:1px solid {age_color}; height:320px;">
        <span style="font-size:28px;">🧬</span>
...
with p4:
    st.markdown(f"""
    <div style="background:#1a1a1a; padding:20px; border-radius:16px; border:1px solid {perf_color}; height:320px;">
        <span style="font-size:28px;">📈</span>
